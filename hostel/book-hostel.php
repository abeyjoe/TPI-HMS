...
$rc=$stmt->bind_param('siiisisissssisississsisssi',$roomno,$seater,$feespm,$foodstatus,$stayfrom,$duration,$course,$regno,$fname,$mname,$lname,$gender,$contactno,$emailid,$emcntno,$gurname,$gurrelation,$gurcntno,$caddress,$ccity,$cstate,$cpincode,$paddress,$pcity,$pstate,$ppincode); // change i = s for roomno
$stmt->execute();
...
<?php $query ="SELECT * FROM rooms ORDER BY RAND() LIMIT 1";
...
<input type="radio" value="1" name="foodstatus"> With Food(₦ 2000.00 Per Month Extra)
</div>
</div>	-->
...
<option selected disabled>Select Duration in Month</option>
<!--
...
<div class="col-sm-8">
<input type="text" name="ta" id="ta"  class="result form-control" disabled>
</div>
</div>
